...
double Statistics::calculateLowestSummerTemperature(const std::vector<double>& data) const {
    ...
    double lowestSummer1 = *std::min_element(summer1Temperatures.begin(), summer1Temperatures.end());
    double lowestSummer2 = *std::min_element(summer2Temperatures.begin(), summer2Temperatures.end());

    return std::min(lowestSummer1, lowestSummer2);
}

double Statistics::calculateLowestWinterTemperature(const std::vector<double>& data) const {
    ...
    double lowestWinter1 = *std::min_element(winter1Temperatures.begin(), winter1Temperatures.end());
    double lowestWinter2 = *std::min_element(winter2Temperatures.begin(), winter2Temperatures.end());
